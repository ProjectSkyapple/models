...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'ssd_anchor_generator_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _SSDANCHORGENERATOR._serialized_start=56
  _SSDANCHORGENERATOR._serialized_end=426
